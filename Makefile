...
# This Revision: $Id: Makefile,v 1.2 2014-02-23 04:29:42 cvs Exp $
...
OBJECTS = usbdrv/usbdrv.o usbdrv/usbdrvasm.o usbdrv/oddebug.o main.o virtualboy.o devdesc.o
...
# file targets:
main.bin:	$(COMMON_OBJS) virtualboy.o devdesc.o 
